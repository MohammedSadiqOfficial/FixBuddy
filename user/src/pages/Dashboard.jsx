                    ...
                    {captains.length === 0 ? (
                        ...
                        <div className="space-y-4">
                            {captains.map((captain) => (
                                captain.isVerified && (
                                    <Link key={captain.id} to={`/professionals/${captain.id}`} className="flex flex-col md:flex-row items-end md:items-center justify-between border rounded-xl p-4 hover:shadow-sm transition-all hover:-translate-y-0.5 bg-card/50">
